...
const TURN: IndexBinding = index_binding!(
...
const LIFE_METER_TYPE: IndexBinding = index_binding!(
...
const DATA_VISUALIZATIONS: IndexBinding = index_binding!(
...
const TARGET_SCORE: IndexBinding = index_binding!(
...
const INDICATOR_SCORE_TYPE: IndexBinding = index_binding!(
...
const COMBO_COLORS: IndexBinding = index_binding!(
...
const COMBO_COLOR_MODE: IndexBinding = index_binding!(
    COMBO_MODE_VARIANTS,
...
const ERROR_BAR_TRIM: IndexBinding = index_binding!(
...
const MEASURE_COUNTER: IndexBinding = index_binding!(
...
const MEASURE_LINES: IndexBinding = index_binding!(
...
const TIMING_WINDOWS: IndexBinding = index_binding!(
...
const DENSITY_GRAPH_BACKGROUND: BoolBinding = BoolBinding {
