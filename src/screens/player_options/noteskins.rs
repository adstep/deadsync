...
pub fn noteskin_cols_per_player(play_style: crate::game::profile::PlayStyle) -> usize {
    match play_style {
...
pub fn load_noteskin_cached(skin: &str, cols_per_player: usize) -> Option<Arc<Noteskin>> {
...
pub fn discover_noteskin_names() -> Vec<String> {
    noteskin::discover_itg_skins("dance")
}

pub fn build_noteskin_override_choices(noteskin_names: &[String]) -> Vec<String> {
...
pub fn build_tap_explosion_noteskin_choices(noteskin_names: &[String]) -> Vec<String> {
...
pub fn push_noteskin_name_once(names: &mut Vec<String>, skin: &crate::game::profile::NoteSkin) {
...
pub fn fallback_noteskin(cache: &HashMap<String, Arc<Noteskin>>) -> Option<Arc<Noteskin>> {
    cache
...
pub fn cached_or_load_noteskin(
...
pub fn cached_or_load_noteskin_exact(
    cache: &mut HashMap<String, Arc<Noteskin>>,
    skin: &crate::game::profile::NoteSkin,
    cols_per_player: usize,
) -> Option<Arc<Noteskin>> {
...
pub fn resolved_noteskin_override_preview(
    cache: &mut HashMap<String, Arc<Noteskin>>,
...
pub fn resolved_tap_explosion_preview(
    cache: &mut HashMap<String, Arc<Noteskin>>,
    noteskin: &crate::game::profile::NoteSkin,
...
pub fn sync_noteskin_previews_for_player(state: &mut State, player_idx: usize) {
