...
fn ensure_textures() {
    ...
    ONCE.get_or_init(|| {
        for (key, w, h) in [
            ...
            (CROWN_TEX, 128, 128),
            ("init_arrow_1.png", 77, 90),
            ("init_arrow_2.png", 77, 90),
            ("init_arrow_3.png", 77, 90),
            ("init_arrow_4.png", 77, 90),
            ("init_arrow_5.png", 77, 90),
            ("init_arrow_6.png", 77, 90),
            ("init_arrow_7.png", 77, 90),
