...
| 4 | R1 | Introduce RowBehavior | done | Ported `RowBehavior` enum with typed Cycle/Numeric/Custom/Exit bindings. `apply_submenu_choice_delta` shrunk from 1,329 → 912 lines. All 124 per-`SubRowId` arms removed. |
